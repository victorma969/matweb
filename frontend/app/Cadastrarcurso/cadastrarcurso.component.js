angular.
  ...
  component('registrarCurso', {
    ...
    controller: ['ApiRegistroCurso','$http','$location', 'MatWebGlobals',function(ApiRegistroCurso,$http,$location,MatWebGlobals) {
      var ctrl = this;
      this.formulario = {'nome':'','mec':'','id_campus':'','id_grau':'','permanencia_minima':'','permanencia_maxima':'','creditos_formatura':'','creditos_optativos_concentracao':'','creditos_optativos_conexa':'','creditos_livres_maximo':'','codigo':'',};
